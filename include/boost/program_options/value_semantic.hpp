...
namespace boost { namespace program_options {
    ...
    */
    ...
    public:
        ...
        */
        shared_ptr<typed_value<T, charT>> default_value(const T& v)
        {
        ...
        /** Specifies default value, which will be used
            ...
            by the user.
        */
        shared_ptr<typed_value<T, charT>> default_value(const T& v, const std::string& textual)
        {
            m_default_value = boost::any(v);
        ...
        */
        shared_ptr<typed_value<T, charT>> implicit_value(const T &v)
        {
        ...
        shared_ptr<typed_value<T, charT>> value_name(const std::string& name)
        {
            m_value_name = name;
            return shared_from_this();
        }
        ...
        */
        shared_ptr<typed_value<T, charT>> implicit_value(const T &v, const std::string& textual)
        {
            m_implicit_value = boost::any(v);
        ...
        /** Specifies a function to be called when the final value
            is determined. */
        shared_ptr<typed_value<T, charT>> notifier(function1<void, const T&> f)
        {
            m_notifier = f;
            return shared_from_this();
        }
        ...
        */
        shared_ptr<typed_value<T, charT>> composing()
        {
            m_composing = true;
            return shared_from_this();
        }
        ...
        */
        shared_ptr<typed_value<T, charT>> multitoken()
        {
            m_multitoken = true;
            return shared_from_this();
        }
        ...
        /** Specifies that no tokens may be provided as the value of
            ...
            using this method. */
        shared_ptr<typed_value<T, charT>> zero_tokens()
        {
            m_zero_tokens = true;
            return shared_from_this();
        }
        ...
        shared_ptr<typed_value<T, charT>> required()
        {
            m_required = true;
            return shared_from_this();
        }
